"""DO Sandbox Demo - Todo App (Flask + HTMX)"""
...
todos = [
    ...
    {"id": 2, "text": "Write proposal", "done": False},
    {"id": 3, "text": "Call dentist", "done": False},
]
next_id = 4
...
def _render_items():
    return render_template_string(ITEM, todos=todos, counter_text=_counter())


@app.get("/")
def index():
    items_html = render_template_string(ITEM, todos=todos, counter_text=_counter())
